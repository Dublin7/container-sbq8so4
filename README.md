...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-sbq8so4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-sbq8so4.containers.anotherwebservice.com/
...
```
git clone git@github.com:Dublin7/container-sbq8so4.git
cd container-sbq8so4
```
...
```
docker attach container-sbq8so4
```
